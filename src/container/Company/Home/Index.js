  ...
  for (let i = 0; i < 5; i++) {
    stocks.push(
      <View key={"stock" + i}>
        ...
        >
          <View flexDirection="row" style={{ backgroundColor: "#fff", marginHorizontal: RFValue(12, 580), height: RFValue(124, 580), borderRadius: 20 }}>
            <View flexDirection="column" justifyContent="center" style={{ margin: 12 }}>
              <Image source={Matchwood} style={{ width: RFValue(80, 580), borderRadius: 20}} />
            </View>
        ...
        >
          <View flexDirection="row" style={{ backgroundColor: "#fff", marginHorizontal: RFValue(12, 580), height: RFValue(124, 580), borderRadius: 20 }}>
            <View flexDirection="column" justifyContent="center" style={{ margin: 12 }}>
              <Image source={IronScrap} style={{ width: RFValue(80, 580), borderRadius: 20}} />
            </View>
            <View style={{ marginVertical: 12, flex: 1, marginRight: 12 }}>
              <View flexDirection="row" justifyContent="space-between">
                <Text style={{ fontWeight: "bold", fontSize: 16 }}>
